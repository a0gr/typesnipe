...
import { DevicePermissionContextWrapper } from "@/contexts/DevicePermissionContext";
import RequestDeviceMotionButton from "@/components/RequestDeviceMotionButton";
import DeviceOrientationReader from "@/components/DeviceOrientationReader";

export default function Home() {
  return (
    <DevicePermissionContextWrapper>
